...
<?php echo $this->Form->create('MigTeam'); ?>
	<fieldset>
		<legend><?php echo __('Edit Mig Team'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('MigTeam.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('MigTeam.id'))); ?></li>
