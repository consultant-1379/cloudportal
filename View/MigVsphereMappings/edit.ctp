...
<?php echo $this->Form->create('MigVsphereMapping'); ?>
	<fieldset>
		<legend><?php echo __('Edit Mig Vsphere Mapping'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('MigVsphereMapping.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('MigVsphereMapping.id'))); ?></li>
