...
<div id="tabs" >
	<ul>
	<li><?php echo $this->Html->link("VMs", array('controller' => 'Vms', 'action' => 'vapp_index', 'vapp_id' => $this->passedArgs['vapp_id'], 'orgvdc_id' => $this->passedArgs['orgvdc_id']),array('id' => 'vms_tab_link')); ?></li>
